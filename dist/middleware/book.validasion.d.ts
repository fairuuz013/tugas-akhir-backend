...
export declare const apiKey: (req: Request, res: Response, next: NextFunction) => Response<any, Record<string, any>> | undefined;
export declare const logging: (req: Request, _res: Response, next: NextFunction) => void;
//# sourceMappingURL=book.validasion.d.ts.map