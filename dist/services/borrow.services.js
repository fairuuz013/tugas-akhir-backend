...
;
;
export class BorrowServices {
    borrowRepo;
    prisma;
    constructor(borrowRepo, prisma) {
    ...
    async list({ page, limit, filters }) {
        ...
        const borrows = await this.borrowRepo.list(skip, limit, where, { createdAt: "desc" });
...
;
//# sourceMappingURL=borrow.services.js.map